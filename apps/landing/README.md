...
The `/access-code` page is a branded private demo handoff into the product app. Use production authentication inside the product workspace for protected data.
