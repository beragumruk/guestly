...
from intelligence.fixtures import DEMO_SIGNALS


def main() -> None:
    priorities = Counter(classify_signal(signal).priority for signal in DEMO_SIGNALS)
    issues = Counter(classify_signal(signal).issue_type for signal in DEMO_SIGNALS)
    ...
    print("============================")
    print(f"Signals analyzed: {len(DEMO_SIGNALS)}")
